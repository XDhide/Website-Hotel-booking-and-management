    ...
    <section className="section cs-section">
      <div className="container">
        ...
        <p className="section-subtitle">
          Chọn ngày và loại phòng phù hợp với bạn
        </p>

        <div className="cs-layout">
          <div className="cs-panel">
            <h3 className="cs-panel-title">
              <FilterOutlined className="cs-mr-8" />
              Bộ lọc tìm kiếm
            </h3>
            ...
            {checkIn && (
              <div
                className={`cs-info-box ${isHighDemand ? "warning" : "success"}`}
              >
                {isHighDemand ? (
                  <>
                    <WarningOutlined className="cs-mr-6" />
                    Cuối tuần rất đông! Đặt sớm để đảm bảo phòng.
                  </>
                ) : (
                  <>
                    <CheckCircleOutlined className="cs-mr-6" />
            ...
            >
              <SearchOutlined className="cs-mr-8" />
              Tìm phòng
            </button>
          </div>
          ...
          <div className="cs-results">
            {loading ? (
              <div className="cs-loading-container">
                <LoadingOutlined className="cs-loading-icon" />
              </div>
            ) : filtered.length === 0 ? (
