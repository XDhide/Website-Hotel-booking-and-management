import { apiGetRevenue, apiGetOccupancy } from "../../services/ReportService";
...
export default function Report() {
  ...
  const loadRevenue = async () => {
    ...
    try {
      const res = await apiGetRevenue(startDate, endDate);
  ...
  const loadOccupancy = async () => {
    ...
    setError("");
    try {
      const res = await apiGetOccupancy();
  ...
  return (
    <div className="report-wrapper">
          ...
          <>
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value">
                  {(revenueReport.totalRevenue / 1_000_000).toFixed(1)}M₫
                </div>
                <div className="summary-sub">
                  <RiseOutlined /> {revenueReport.completedBookings} booking
                  hoàn thành
                </div>
              </div>
            </div>
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value">
                  {revenueReport.totalBookings}
                </div>
                <div className="summary-sub">
                  {revenueReport.cancelledBookings} đã huỷ
                </div>
              </div>
            </div>
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value">
                  {(revenueReport.averageBookingValue / 1_000_000).toFixed(1)}M₫
                </div>
            ...
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value small">
                  {new Date(revenueReport.startDate).toLocaleDateString(
                    "vi-VN",
                  )}
                </div>
                <div className="summary-sub">
                  →{" "}
                  {new Date(revenueReport.endDate).toLocaleDateString("vi-VN")}
                </div>
              </div>
            </div>
          </>
          ...
          <>
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value">
                  {occupancyReport.checkedInBookings}
                </div>
            ...
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value">
                  {occupancyReport.confirmedBookings}
                </div>
            ...
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value">
                  {occupancyReport.pendingBookings}
                </div>
            ...
            <div className="summary-card">
              ...
              <div className="summary-info">
                ...
                <div className="summary-value">
                  {occupancyReport.totalBookings}
                </div>
                <div className="summary-sub">
                  {new Date(occupancyReport.date).toLocaleDateString("vi-VN")}
                </div>
              </div>
            </div>
          </>
      ...
      <div className="report-chart-card">
        <div className="chart-header">
          ...
          <div className="chart-controls">
            <div className="tab-group">
              ...
              <button
                className={tab === "occupancy" ? "active" : ""}
            ...
            <button
              onClick={() =>
                tab === "revenue" ? loadRevenue() : loadOccupancy()
              }
        ...
        {loading ? (
          <div className="report-loading">Đang tải...</div>
          ...
          <div className="chart-area">
            {(revenueReport.dailyRevenues ?? []).map((d: any, i: number) => {
              ...
              const monthLabel = new Date(d.date).toLocaleDateString("vi-VN", {
                month: "short",
              });
              return (
          ...
          <div className="report-occ-wrap">
            {[
              {
                label: "CheckedIn",
                val: occupancyReport.checkedInBookings,
                color: "#22c55e",
              },
              {
                label: "Confirmed",
                val: occupancyReport.confirmedBookings,
                color: "#3b82f6",
              },
              {
                label: "Pending",
                val: occupancyReport.pendingBookings,
                color: "#eab308",
              },
            ].map((item) => (
              <div key={item.label} className="report-occ-item">
                <div className="report-occ-val" style={{ color: item.color }}>
                  {item.val}
                </div>
                <div className="report-occ-lbl">{item.label}</div>
              </div>
            ))}
          </div>
        ) : null}
        ...
        (revenueReport.dailyRevenues ?? []).length > 0 && (
          <div className="report-table-card">
            ...
            <table className="report-table">
              ...
              <tbody>
                {(revenueReport.dailyRevenues ?? []).map(
                  (d: any, i: number) => (
                    <tr key={i}>
                      <td>{i + 1}</td>
