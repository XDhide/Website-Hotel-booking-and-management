          ...
          <aside className="rl-sidebar">
            <div className="rl-filter-box">
              ...
              <div className="rl-filter-group">
                ...
                <input
                  type="range" min={400_000} max={5_000_000} step={100_000}
                  value={priceMax} onChange={(e) => setPriceMax(Number(e.target.value))}
                  className="rl-range"
                />
                <div className="rl-range-labels"><span>400K</span><span>5M</span></div>
              </div>

              <div className="rl-filter-group">
                <label className="rl-checkbox-label">
                  <input
                    type="checkbox" checked={onlyAvail}
            ...
            <div className="rl-toolbar">
              ...
              <div className="rl-toolbar-right">
                ...
                <div className="rl-view-toggle">
                  <button className={`rl-view-btn${view === "grid" ? " active" : ""}`} onClick={() => setView("grid")}>
                    <AppstoreOutlined />
                  </button>
                  <button className={`rl-view-btn${view === "list" ? " active" : ""}`} onClick={() => setView("list")}>
                    <BarsOutlined />
                  </button>
                </div>
              </div>
